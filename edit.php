...
if(isset($_POST['submit']))
  {
    ...
    //Query for data updation
     $query=mysqli_query($con, "update  tblusers set FirstName='$name', MobileNumber='$contno', Email='$email', Address='$add' where ID='$eid'");
...
?>
        ...
        <div class="form-group">
			<div class="row">
				<div class="col"><input type="text" class="form-control" name="name" value="<?php  echo $row['FirstName'];?>" required="true"></div>
